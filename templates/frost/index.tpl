...
{if $projectnum > 0}
	...
	<div class="projects">
			...
			<div class="headline">
				...
				<h2>
					<a href="myprojects.php" title="{#myprojects#}"><img src="./templates/frost/images/symbols/projects.png" alt="" />{#myprojects#}</a>
				</h2>
			</div>
...
{if $tasknum > 0}
	<div class="tasks">
			...
			<div class="headline">
				...
				<h2>
					<a href="mytasks.php" title="{#mytasks#}"><img src="./templates/frost/images/symbols/tasklist.png" alt="" />{#mytasks#}</a>
				</h2>
			...
			<div class="headline">
				...
				<div class="wintools">
					...
					<div class = "progress" id = "progress" style = "display:none;">
						<img src = "templates/frost/images/symbols/loader-cal.gif" />
					</div>
				</div>


				<h2>
					<img src="./templates/frost/images/symbols/miles.png" alt="" />{#calendar#}
				</h2>
...
{if $msgnum > 0}
	<div class="msgs">
			...
			<div class="headline">
				...
				<h2>
					<a href="managemessage.php?action=mymsgs" title="{#mymessages#}"><img src="./templates/frost/images/symbols/msgs.png" alt="" />{#mymessages#}</a>
				</h2>
			</div>
																				...
																				<td class="thumb">
																				 	<a href = "{$messages[message].files[file].datei}" {if $messages[message].files[file].imgfile == 1} rel="lytebox[]" {elseif $messages[message].files[file].imgfile == 2} rel = "lyteframe[text]" {/if} title="{$messages[message].files[file].name}">
																						{if $messages[message].files[file].imgfile == 1}
																				 		...
																				 		{else}
																						<img src = "templates/frost/images/files/{$messages[message].files[file].type}.png" alt="{$messages[message].files[file].name}" />
																				 		{/if}
																					</a>
																				</td>
