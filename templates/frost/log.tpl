			<div class="headline">
				...
				<h2>
					<img src="./templates/frost/images/symbols/activity.png" alt="" />{#activity#}
				</h2>
				...
				<table class="log" cellpadding="0" cellspacing="0" border="0">
					...
					{/if}
						<tr>
							...
							<img style="margin:0 0 0 3px;" src="./templates/frost/images/symbols/tasklist.png" alt="" />

							{elseif $log[logitem].type == "user"}
							<img style="margin:0 0 0 3px;" src="./templates/frost/images/symbols/user.png" alt="" />

							{elseif $log[logitem].type == "task"}
							<img style="margin:0 0 0 3px;" src="./templates/frost/images/symbols/task.png" alt="" />

							{elseif $log[logitem].type == "projekt"}
							<img style="margin:0 0 0 3px;" src="./templates/frost/images/symbols/projects.png" alt="" />

							{elseif $log[logitem].type == "milestone"}
							<img style="margin:0 0 0 3px;" src="./templates/frost/images/symbols/miles.png" alt="" />

							{elseif $log[logitem].type == "message"}
							<img style="margin:0 0 0 3px;" src="./templates/frost/images/symbols/msgs.png" alt="" />

							{elseif $log[logitem].type == "datei"}
							<img style="margin:0 0 0 3px;" src = "./templates/frost/images/symbols/files.png" alt="" />

							{elseif $log[logitem].type == "track"}
							<img style="margin:0 0 0 3px;" src = "./templates/frost/images/symbols/timetracker.png" alt="" />
