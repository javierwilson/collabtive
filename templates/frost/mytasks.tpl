...
<div class="tasks">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
	    {if $mode == "added"}
	    <span class="info_in_green"><img src="templates/frost/img/symbols/task.png" alt=""/>{#taskwasadded#}</span>
	    {elseif $mode == "edited"}
	    <span class="info_in_yellow"><img src="templates/frost/img/symbols/task.png" alt=""/>{#taskwasedited#}</span>
	    {elseif $mode == "deleted"}
	    <span class="info_in_red"><img src="templates/frost/img/symbols/task.png" alt=""/>{#taskwasdeleted#}</span>
	    {elseif $mode == "opened"}
	    <span class="info_in_green"><img src="templates/frost/img/symbols/task.png" alt=""/>{#taskwasopened#}</span>
	    {elseif $mode == "closed"}
	    <span class="info_in_red"><img src="templates/frost/img/symbols/task.png" alt=""/>{#taskwasclosed#}</span>
	    {elseif $mode == "assigned"}
	    <span class="info_in_yellow"><img src="templates/frost/img/symbols/task.png" alt=""/>{#taskwasassigned#}</span>
	    {elseif $mode == "deassigned"}
	    <span class="info_in_yellow"><img src="templates/frost/img/symbols/task.png" alt=""/>{#taskwasdeassigned#}</span>
	    {elseif $mode == "listclosed"}
	    <span class="info_in_red"><img src="templates/frost/img/symbols/tasklist.png" alt=""/>{#tasklistwasclosed#}</span>
	    {elseif $mode == "listdeleted"}
	    <span class="info_in_red"><img src="templates/frost/img/symbols/tasklist.png" alt=""/>{#tasklistwasdeleted#}</span>
	    {/if}
	</div>
	{literal}
	...
	{if $myprojects[project].tasknum}
			...
			<div class="headline">
				...
				<h2>
					<a href="managetask.php?action=showproject&amp;id={$myprojects[project].ID}" title="{$myprojects[project].name} / {#mytasks#}"><img src="./templates/frost/images/symbols/projects.png" alt="" />{$myprojects[project].name}</a>
				</h2>
			</div>
				...
				<table id="acc_{$myprojects[project].ID}" cellpadding="0" cellspacing="0" border="0">
					...
					{/if}
						<tr {if $myprojects[project].tasks[task].daysleft < 0} class="marker-late"{elseif $myprojects[project].tasks[task].daysleft == 0} class="marker-today"{/if}>
							...
							<td>{$myprojects[project].tasks[task].daysleft}</td>
							<td class="tools">
					...
					<table cellpadding="0" cellspacing="0" border="0" id = "done_{$myprojects[project].ID}">
						...
						{/if}
							...
							<tr>
								...
								<td class="d">{$myprojects[project].oldtasks[oldtask].daysleft}</td>
								<td class="tools">
									{if $userpermissions.tasks.edit}
