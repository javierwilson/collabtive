...
<!--
				<tbody class="color-b">
					<tr>
						...
						<td class="right"><input type = "text" class="text" value = "{$user.realname}" name = "realname" id="realname" required="1" realname="{#name#}" /></td>
					</tr>
				</tbody>
-->
...
<!--
				<tbody class="color-b">
					<tr>
						...
						<td class="right"><input type = "text" class="text" value = "{$user.company.role}" name = "role" id="role" required="1" realname="{#role#}" /></td>
					</tr>
				</tbody>
				-->
				<tbody class="color-b">
