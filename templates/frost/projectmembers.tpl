...
<div class="user">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "added"}
		<span class="info_in_green"><img src="templates/frost/images/symbols/user-icon-male.png" alt=""/>{#userwasadded#}</span>
		{elseif $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/frost/images/symbols/user-icon-male.png" alt=""/>{#userwasedited#}</span>
		{elseif $mode == "deleted"}
		<span class="info_in_red"><img src="templates/frost/images/symbols/user-icon-male.png" alt=""/>{#userwasdeleted#}</span>
		{elseif $mode == "assigned"}
		<span class="info_in_yellow"><img src="templates/frost/images/symbols/user-icon-male.png" alt=""/>{#userwasassigned#}</span>
		{elseif $mode == "deassigned"}
		<span class="info_in_yellow"><img src="templates/frost/images/symbols/user-icon-male.png" alt=""/>{#userwasdeassigned#}</span>
		{/if}
	</div>
	{literal}
...
<h1>{$projectname}<span>/ {#members#}</span></h1>
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/frost/images/symbols/userlist.png" alt="" />{#members#}</a>
				</h2>
