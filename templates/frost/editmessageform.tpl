...
<a href="managemessage.php?action=showproject&amp;id={$project.ID}" title="{$project.name}"><img src="./templates/frost/images/symbols/projects.png" alt="" />{$message.pname}</a>
<a href="managemessage.php?action=showmessage&amp;id={$project.ID}&mid={$message.ID}"><img src="./templates/frost/images/symbols/msgs.png" alt="" />{#message#}</a>
</div>
