...
<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "added"}
		<span class="info_in_green"><img src="templates/frost/images/symbols/miles.png" alt=""/>{#milestonewasadded#}</span>
		{elseif $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/frost/images/symbols/miles.png" alt=""/>{#milestonewasedited#}</span>
		{elseif $mode == "deleted"}
		<span class="info_in_red"><img src="templates/frost/images/symbols/miles.png" alt=""/>{#milestonewasdeleted#}</span>
		{elseif $mode == "opened"}
		<span class="info_in_green"><img src="templates/frost/images/symbols/miles.png" alt=""/>{#milestonewasopened#}</span>
		{elseif $mode == "closed"}
		<span class="info_in_red"><img src="templates/frost/images/symbols/miles.png" alt=""/>{#milestonewasclosed#}</span>
		{/if}
	</div>
...
{*Milestones*}
			<div class="headline">
				...
				<h2>
					<img src="./templates/frost/images/symbols/miles.png" alt="" />{#milestones#}
				</h2>
							...
							<tr{if $milestones[stone].daysleft == 0} class="marker-today"{/if}>
								...
								<td class="b">
									<div class="toggle-in">
										...
										<a href="managemilestone.php?action=showmilestone&amp;msid={$milestones[stone].ID}&amp;id={$project.ID}">{$milestones[stone].name|truncate:30:"...":true}</a>
									</div>
								</td>
							...
							<tr>
								...
								<td class="b">
									<div class="toggle-in">
										...
										<a href="managemilestone.php?action=showmilestone&amp;msid={$donemilestones[stone].ID}&amp;id={$project.ID}">{$donemilestones[stone].name|truncate:30:"...":true}</a>
									</div>
								</td>
