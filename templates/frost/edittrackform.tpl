...
<a href="managetimetracker.php?action=showproject&amp;id={$project.ID}"><img src="./templates/frost/images/symbols/timetracker.png" alt="" />{#timetracker#}</a>

</div>

<h1 class="second"><img src="./templates/frost/images/symbols/timetracker.png" alt="" />{$track.username} ({$track.hours})</h1>
