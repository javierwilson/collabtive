...
<div class="tasks">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "added"}
		<span class="info_in_green"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasadded#}</span>
		{elseif $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasedited#}</span>
		{elseif $mode == "deleted"}
		<span class="info_in_red"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasdeleted#}</span>
		{elseif $mode == "opened"}
		<span class="info_in_green"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasopened#}</span>
		{elseif $mode == "closed"}
		<span class="info_in_red"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasclosed#}</span>
		{elseif $mode == "assigned"}
		<span class="info_in_yellow"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasassigned#}</span>
		{elseif $mode == "deassigned"}
		<span class="info_in_yellow"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasdeassigned#}</span>
		...
		<span class="info_in_green"><img src="templates/frost/images/symbols/tasklist.png" alt=""/>{#tasklistwasopened#}</span>
		{/if}

		{*for async display*}
		<span id = "added" style = "display:none;" class="info_in_green"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasadded#}</span>
		<span id = "edited" style = "display:none;" class="info_in_yellow"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasedited#}</span>
		<span id = "deleted" style = "display:none;" class="info_in_red"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasdeleted#}</span>
		<span id = "opened" style = "display:none;" class="info_in_green"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasopened#}</span>
		<span id = "closed" style = "display:none;" class="info_in_green"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasclosed#}</span>
		<span id = "assigned" style = "display:none;" class="info_in_yellow"><img src="templates/frost/images/symbols/task.png" alt=""/>{#taskwasassigned#}</span>
...
<h1>{$projectname}<span>/ {#tasklists#}</span></h1>
...
{section name=list loop=$lists}
			...
			<div class="headline">
				...
				<h2>
					<a href="managetasklist.php?action=showtasklist&amp;id={$project.ID}&amp;tlid={$lists[list].ID}" title="{#tasklist#} {$lists[list].name}"><img src="./templates/frost/images/symbols/tasklist.png" alt="" />{$lists[list].name}</a>
				</h2>
				...
				<table id="acc_{$lists[list].ID}" cellpadding="0" cellspacing="0" border="0">
					...
					{/if}
						<tr {if $lists[list].tasks[task].daysleft < 0} class="marker-late"{elseif $lists[list].tasks[task].daysleft == 0} class="marker-today"{/if}>
							<td>{if $userpermissions.tasks.close}
                            <a class="butn_check" href="javascript:closeElement('task_{$lists[list].tasks[task].ID}','managetask.php?action=close&amp;tid={$lists[list].tasks[task].ID}&amp;id={$project.ID}');" title="{#close#}"></a>{/if}</td>
							<td>
								<div class="toggle-in">
...
{*Done Tasklists*}
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/frost/images/symbols/tasklist-done.png" alt="" />{#donetasklists#}
				</h2>
			</div>
