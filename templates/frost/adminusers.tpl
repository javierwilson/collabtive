...
<div class="user">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "deleted"}
		<span class="info_in_red"><img src="templates/frost/images/symbols/userlist.png" alt=""/>{#userwasdeleted#}</span>
		{elseif $mode == "added"}
		<span class="info_in_green"><img src="templates/frost/images/symbols/userlist.png" alt=""/>{#userwasadded#}</span>
		{elseif $mode == "roleadded"}
		<span class="info_in_green"><img src="templates/frost/images/symbols/userlist.png" alt=""/>{#roleadded#}</span>
		{elseif $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/frost/images/symbols/userlist.png" alt=""/>{#userwasedited#}</span>
        {elseif $mode == "de-assigned"}
		<span class="info_in_yellow"><img src="templates/frost/images/symbols/userlist.png" alt=""/>{#permissionswereedited#}</span>
		{/if}
	</div>
	{literal}
...
<h1>{#administration#}<span>/ {#useradministration#}</span></h1>
	...
	<div class="headline">
				...
				<h2>
					<img src="./templates/frost/images/symbols/userlist.png" alt="" />{#useradministration#}
				</h2>
