...
{else}
		{if $user.gender == "f"}
		<img src = "thumb.php?pic=templates/frost/images/no-avatar-female.jpg&amp;width=80;" style="float:left;margin-left:10px;" alt="" />
		{else}
		<img src = "thumb.php?pic=templates/frost/images/no-avatar-male.jpg&amp;width=80;" style="float:left;margin-left:10px;" alt="" />
		{/if}
{/if}
<div class="row">
