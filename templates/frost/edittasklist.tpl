...
<a href="managetasklist.php?action=showtasklist&amp;id={$project.ID}&amp;tlid={$tasklist.ID}"><img src="./templates/frost/images/symbols/tasklist.png" alt="" />{$tasklist.name|truncate:55:"...":true}</a>
</div>

<h1 class="second"><img src="./templates/frost/images/symbols/tasklist.png" alt="" />{$tasklist.name|truncate:30:"...":true}</h1>
