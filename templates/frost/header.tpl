...
{if $jsload3 == "lightbox"}
<link rel="stylesheet" href="templates/frost/css/lytebox.css" type="text/css"  />
...
{/literal}
{/if}
<link rel="stylesheet" type="text/css" href="templates/frost/css/style_main.css"/>

<!--[if lte IE 7]>
<link rel="stylesheet" type="text/css" href="templates/frost/css/style_iefix.css"/>
<![endif]-->
<!--[if lte IE 6]>
<script language="JavaScript" type="text/javascript" src="templates/frost/js/pngfix.js"></script>
<![endif]-->
</head>
<body >
