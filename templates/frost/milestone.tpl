...
<a href="managemilestone.php?action=showproject&amp;id={$project.ID}"><img src="./templates/frost/images/symbols/miles.png" alt="" />{#milestones#}</a>

</div>


<h1 class="second"><img src="./templates/frost/images/symbols/miles.png" alt="" />{$milestone.name}</h1>
												...
												<tr>
													...
													<td class="thumb">
														<a href="managetasklist.php?action=showtasklist&amp;tlid={$milestone.tasks[task].ID}&amp;id={$project.ID}" title="{$milestone.tasks[task].name}">
																<img src = "./templates/frost/images/symbols/tasklist.png" style="width: 32px; height: auto;" alt="" />
														</a>
													</td>
												...
												<tr>
													...
													<td class="thumb">
														<a href="managemessage.php?action=showmessage&amp;mid={$milestone.messages[msg].ID}&amp;id={$project.ID}" title="{$milestone.messages[msg].title}">
																<img src = "./templates/frost/images/symbols/msgs.png" style="width: 32px; height: auto;" alt="" />
														</a>
													</td>
													<td class="rightmen" valign="top">
														<div class="inmenue">
