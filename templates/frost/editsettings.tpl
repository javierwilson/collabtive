...
<div class="neutral">
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/frost/images/symbols/system-settings.png" alt=""/>{#settingsedited#}</span>
        {elseif $mode == "imported"}
        <span class="info_in_green"><img src="templates/frost/images/symbols/basecamp.png" alt=""/>{#importsuccess#}</span>
...
<h1>{#administration#}<span>/ {#systemadministration#}</span></h1>
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/frost/images/symbols/system-settings.png" alt="" />{#systemadministration#}</a>
				</h2>
			</div>
...
<div class="content-spacer"></div>
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/frost/images/symbols/basecamp.png" alt="" />{#import#}</a>
				</h2>
			</div>
...
<div class="content-spacer"></div>
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/frost/images/symbols/msgs.png" alt="" />{#email#}</a>
				</h2>
			</div>
