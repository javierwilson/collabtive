...
<a href="managefile.php?action=showproject&amp;id={$project.ID}" ><img src="./templates/frost/images/symbols/projects.png" alt="" />{$projectname|truncate:25:"...":true}</a>

</div>

<h1 class="second"><img src="./templates/frost/images/symbols/files.png" alt="" />{$file.title|truncate:30:"...":true}</h1>
