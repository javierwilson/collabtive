...
<div class="login">
	<div class="login-in">
		<div class="logo-name">
			<h1><a href = "http://collabtive.o-dyn.de/"><img src="./templates/frost/images/logo-a.png" alt="{$settings.name}" /></a></h1>
		...
		<form id = "loginform" name = "loginform" method="post" action="manageuser.php?action=login" {literal} onsubmit="return validateCompleteForm(this,'input_error');"{/literal}>
			...
			<div class="row">
				<button type="submit" class="loginbutn" title="{#loginbutton#}" onfocus="this.blur();">{#loginbutton#}</button>
			</div>
