<div id="content-right">
	...
	<div class="content-right-in">
			...
			<fieldset>
				...
				<div id="indicator1" style="display:none;"><img src="templates/frost/images/symbols/indicator_arrows.gif" alt="{#searching#}" /></div>
				
				<button type="submit" title="{#gosearch#}" >{#gosearch#}</button>
			</fieldset>
