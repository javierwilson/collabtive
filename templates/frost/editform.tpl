...
<a href="manageproject.php?action=showproject&amp;id={$project.ID}" title="{$project.name}"><img src="./templates/frost/images/symbols/projects.png" alt="" />{$project.name|truncate:50:"...":true}</a>
<span>&nbsp;/...</span>
</div>

<h1 class="second"><img src="./templates/frost/images/symbols/projects.png" alt="" />{$project.name}</h1>
