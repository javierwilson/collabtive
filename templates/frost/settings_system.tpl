				...
				<div class="block_in_wrapper">
					...
					<div class="row"><label for = "name">{#name#}:</label><input type = "text" class="text" value = "{$settings.name}" name = "name" id="name" required = "1" realname = "{#name#}" /></div>
					<div class="row"><label for = "subtitle">{#subtitle#}:</label><input type="text" class="text" value="{$settings.subtitle}" name="subtitle" id="subtitle" /></div>
					...
					<!--<input type = "hidden" name = "dateformat" id = "dateformat" value  = "{$settings.dateformat}" />-->
					<div class="row">
