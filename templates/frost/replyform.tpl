...
<a href="manageproject.php?action=showproject&amp;id={$project.ID}" title="{$project.name}"><img src="./templates/frost/images/symbols/projects.png" alt="" />{$project.name|truncate:25:"...":true}</a>
<a href="managetask.php?action=showproject&amp;id={$project.ID}"><img src="./templates/frost/images/symbols/msgs.png" alt="" />{#messages#}</a>
<a href="managetasklist.php?action=showtasklist&amp;id={$project.ID}&amp;tlid={$tasklist.ID}"><img src="./templates/frost/images/symbols/msgs.png" alt="" />{$message.name|truncate:50:"...":true}</a><span>&nbsp;/...</span>
</div>

<h1 class="second"><img src="./templates/frost/images/symbols/msgs.png" alt="" />{$message.name}</h1>
...
{/if}
				...
				<h2>{#answer#}</h2>
					...
					<fieldset>
						...
						<div class="row"><label for="text">{#text#}</label><div class="editor"><textarea name="text" id="text"  realname="{#text#}" rows="3" cols="1"></textarea></div></div>
