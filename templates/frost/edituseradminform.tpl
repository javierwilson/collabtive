...
<form class="main" method="post" action="admin.php?action=edituser&amp;id={$user.ID}" enctype="multipart/form-data" {literal}onsubmit="return validateCompleteForm(this,'input_error');"{/literal}>
<fieldset>
				...
				<tbody class="color-b">
					<tr>
						...
						<td class="right">
								...
								<div class="fileinput" >
										<input type="file" class="file" name = "userfile" id="avatar"  realname="{#file#}" size="26" onchange = "thefile.value = this.value;"  tabindex="2" />
