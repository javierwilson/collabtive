...
<div class="timetrack">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "added"}
		<span class="info_in_green"><img src="templates/frost/images/symbols/timetracker.png" alt=""/>{#timetracker#} {#was#} {#added#}</span>
		{elseif $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/frost/images/symbols/timetracker.png" alt=""/>{#timetracker#} {#was#} {#edited#}</span>
		{elseif $mode == "deleted"}
		<span class="info_in_red"><img src="templates/frost/images/symbols/timetracker.png" alt=""/>{#timetracker#} {#was#} {#deleted#}</span>
		{/if}
	</div>
	{literal}
