...
<div class="tasks">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		{if $mode == "edited"}
		<span class="info_in_yellow"><img src="templates/frost/img/symbols/tasklist.png" alt=""/>{#tasklistwasedited#}</span>
		{/if}
	</div>
	{literal}
...
<h1 class="second"><img src="./templates/frost/images/symbols/tasklist.png" alt="" />{$tasklist.name|truncate:40:"...":true}</h1>
	...
	<div id="descript" class="descript" style="display:none;">
		...
		<div class="content-spacer"></div>
			...
			<div class="headline">
				...
				<h2>
					<img src="./templates/frost/images/symbols/tasklist.png" alt="" />{#newtasks#}</a>
				</h2>
			</div>
