...
<div class="files">
	...
	<div class="infowin_left" style = "display:none;" id = "systemmsg">
		...
		<span class="info_in_green"><img src="templates/standard/images/symbols/folder.png" alt=""/>{#folderwasadded#}</span>
		{elseif $mode == "folderedited"}
		<span class="info_in_yellow"><img src="templates/standard/images/symbols/folder.png" alt=""/>{#folderwasedited#}</span>
		{elseif $mode == "folderdel"}
		<span class="info_in_red"><img src="templates/standard/images/symbols/folder.png" alt=""/>{#folderwasdeleted#}</span>
		{/if}
	</div>
	{literal}
