...
?>";
    ...
    //Create MySQL Tables
    $table1 = pg_query("CREATE TABLE company (
  ID int(10) NOT NULL serial,
  ...
  KEY name (name)
    ...
    $table2 = pg_query("CREATE TABLE company_assigned (
  ID int(10) NOT NULL serial,
  ...
  KEY user (user)
    ...
    $table3 = pg_query("CREATE TABLE files (
  ID int(10) NOT NULL serial,
  name varchar(255) NOT NULL default '',
  ...
  KEY tags (tags)
    ...
    $table4 = pg_query("CREATE TABLE log (
  ID int(10) NOT NULL serial,
  user int(10) NOT NULL default '0',
  ...
  FULLTEXT KEY name (name)
    ...
    $table5 = pg_query("CREATE TABLE messages (
  ID int(10) NOT NULL serial,
  project int(10) NOT NULL default '0',
  title varchar(255) NOT NULL default '',
  text text NOT NULL,
  ...
  KEY tags (tags)
    ...
    $table6 = pg_query("CREATE TABLE milestones (
  ID int(10) NOT NULL serial,
  project int(10) NOT NULL default '0',
  name varchar(255) NOT NULL default '',
  desc text NOT NULL,
...
");
    ...
    $table7 = pg_query("CREATE TABLE milestones_assigned (
  ID int(10) NOT NULL serial,
  user int(10) NOT NULL default '0',
  milestone int(10) NOT NULL default '0',
  PRIMARY KEY  (ID),
  ...
  KEY milestone (milestone)
    ...
    $table8 = pg_query("CREATE TABLE projekte (
  ID int(10) NOT NULL serial,
  name varchar(255) NOT NULL default '',
  desc text NOT NULL,
  start varchar(255) NOT NULL default '',
  ...
  KEY status (status)
    ...
    $table9 = pg_query("CREATE TABLE projekte_assigned (
  ID int(10) NOT NULL serial,
  user int(10) NOT NULL default '0',
  ...
  KEY projekt (projekt)
    ...
    $table10 = pg_query("CREATE TABLE settings (
  ...
  KEY template (template)
    ...
    $table11 = pg_query("CREATE TABLE tasklist (
  ID int(10) NOT NULL serial,
  project int(10) NOT NULL default '0',
  name varchar(255) NOT NULL default '',
  desc text NOT NULL,
  ...
  KEY milestone (milestone)
    ...
    $table12 = pg_query("CREATE TABLE tasks (
  ID int(10) NOT NULL serial,
  start varchar(255) NOT NULL default '',
  end varchar(255) NOT NULL default '',
  title varchar(255) NOT NULL default '',
  ...
  KEY end (end)
    ...
    $table13 = pg_query("CREATE TABLE tasks_assigned (
  ID int(10) NOT NULL serial,
  user int(10) NOT NULL default '0',
...
CREATE TABLE user (
  ...
  KEY locale (locale)
    ...
    $table15 = pg_query("CREATE TABLE chat (
  ID int(10) NOT NULL serial,
  ...
  PRIMARY KEY  (ID)
    ...
    $table16 = pg_query("CREATE TABLE files_attached (
  ID int(10) unsigned NOT NULL serial,
  ...
  KEY file (file,message)
    ...
    $table17 = pg_query("CREATE TABLE timetracker (
  ID int(10) NOT NULL serial,
  user int(10) NOT NULL default '0',
  project int(10) NOT NULL default '0',
  task int(10) NOT NULL default '0',
  ...
  KEY ended (ended)
    ...
    $table18 = pg_query("CREATE TABLE projectfolders (
  ID int(10) unsigned NOT NULL serial,
...
CREATE TABLE roles_assigned (
  ...
  PRIMARY KEY  (ID)
    ...
    $ins = pg_query("INSERT INTO settings (name,subtitle,locale,timezone,dateformat,template,mailnotify,mailfrom,mailmethod) VALUES ('Collabtive','Projectmanagement','$locale','$timezone','d.m.Y','standard',1,'collabtive@localhost','mail')");
